          ...
          <div class="row">
            ...
            <table class="text-center infotable">
              ...
              <tr>
                ...
                <td>
                  <!-- <input class="form-control" type="text" pattern="[0-9]" id="roll" placeholder="Roll Num.." name="roll"> -->
                  <select class="form-control" name="roll_select" id="roll">
                   <option value=""></option>
				            <?php
...
while ($row = mysqli_fetch_assoc($result)) {
    $std = $row['roll'];?>
              ...
              <tr>
                <td colspan="2" class="text-center">
                  <input class="btn btn-danger" type="submit" name="showinfo" value="Submit">
                </td>
              </tr>
            </table>
          </form>
    ...
    // $choose = $_POST['choose'];
    echo $roll = $_POST['roll_select'];
    if (!empty($roll)) { //$choose && 
        $query = mysqli_query($db_con, "SELECT * FROM `students` WHERE `roll`='$roll'");
