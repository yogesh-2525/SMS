     ...
     <div class="card text-white bg-primary mb-3">
      <div class="card-header">
        <div class="row">
          ...
          <div class="col-sm-8">
            <div class="float-sm-right">&nbsp;<span style="font-size: 30px"><?php $stu=mysqli_query($db_con,'SELECT * FROM `students`'); $stu= mysqli_num_rows($stu); echo $stu; ?></span></div>
...
<table class="table  table-striped table-hover table-bordered" id="data">
  ...
  <tbody>
    <?php 
      $query=mysqli_query($db_con,'SELECT * FROM `students` ORDER BY `students`.`datetime` DESC;');
      $i=1;
