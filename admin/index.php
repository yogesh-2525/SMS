        ...
        <div class="row">
          <div class="col-md-2">
            <div class="list-group">
              ...
              <a href="index.php?page=add-class" class="list-group-item list-group-item-action"><i class="fa fa-user"></i> Create Class</a>
              <a href="index.php?page=all-class" class="list-group-item list-group-item-action"><i class="fa fa-user"></i> All Class</a>
            </div>
          </div>
          <div class="col-md-10">
             <div class="content">
